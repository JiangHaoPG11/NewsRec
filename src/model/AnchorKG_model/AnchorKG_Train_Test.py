from model.AnchorKG_model.AnchorKG import AnchorKG
from model.AnchorKG_model.Recommender import Recommender
from model.AnchorKG_model.Reasoner import Reasoner
from model.AnchorKG_model.AnchorKG_Trainer import Trainer
import torch
...
class AnchorKG_Train_Test():
    def __init__(self, args, data, device):
        ...
        subgraph_model = AnchorKG(args, news_entity_dict, entity_news_dict, user_click_dict,
                                news_category_index, category_news_dict,
                                news_title_embedding, entity_embedding, relation_embedding,
                                entity_adj, relation_adj, device).to(device)
