from model.KGAT_model.KGAT import KGAT_model
from model.KGAT_model.KGAT_Trainer import Trainer
import torch

class KGAT_Train_Test():
    def __init__(self, args, data, device):
        ...
        KGAT = KGAT_model(args, news_title_embedding, entity_embedding, relation_embedding, news_entity_dict,  entity_adj, relation_adj, user_click_dict).to(device)
        optimizer_KGAT = torch.optim.Adam(KGAT.parameters(), lr = 0.0001)
        self.trainer = Trainer(args, KGAT, optimizer_KGAT, data)
