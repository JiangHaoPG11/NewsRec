...
class Trainer():
    ...
    def _train_epoch(self):
        ...
        for data in self.train_dataloader:
            ...
            score = self.KPRN_model(candidate_newsindex, user_index)
            rec_loss = self.optimize_kprn(score, label)
    ...
    def _save_checkpoint(self, epoch):
        state = self.KPRN_model.state_dict()
        filename = self.args.checkpoint_dir + ('checkpoint-news-anchor-epoch{}.pth'.format(epoch))
