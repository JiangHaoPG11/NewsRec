from model.LSTUR_model.LSTUR import LSTUR
from model.LSTUR_model.LSTUR_Trainer import Trainer
import torch

class LSTUR_Train_Test():
    def __init__(self, args, data, device):
        ...
        LSTUR_model = LSTUR(args, entity_embedding, relation_embedding,
        ...
        optimizer_LSTUR = torch.optim.Adam(LSTUR_model.parameters(), lr=0.0001)
        self.trainer = Trainer(args, LSTUR_model, optimizer_LSTUR, data)
    ...
    def Test_load(self):
        self.LSTUR_model.load_state_dict(torch.load(self.args.checkpoint_dir + 'checkpoint-' + self.args.mode + '-epochfinal.pth'))
        self.trainer.test()