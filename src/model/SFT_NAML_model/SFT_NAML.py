...
class SFT_NAML(torch.nn.Module):
    ...
    def get_user_news_rep(self, candidate_news_index, user_clicked_news_index):
        ...
        for i in range(self.args.batch_size):
            ...
            # 点击新闻表征
            clicked_news_rep, _, _, _ = self.news_encoder(clicked_news_word_embedding_one, clicked_news_category_index, clicked_news_subcategory_index)
            # 用户表征
    ...
    def test(self, candidate_newsindex, user_index, user_clicked_newsindex, user_type_index, news_type_index ):
        ...
        return score, user_rep_update.view(self.args.batch_size, 1, -1), news_rep_update
