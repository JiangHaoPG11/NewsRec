from model.SFT_NAML_model.SFT_NAML import SFT_NAML
from model.SFT_NAML_model.SFT_NAML_Trainer import Trainer
import torch
...
class SFT_NAML_Train_Test():
    def __init__(self, args, data, device):
        ...
        optimizer_att = torch.optim.Adam([{"params": SFT_NAML_model.news_att_encoder.parameters()},
                                          {"params": SFT_NAML_model.user_att_encoder.parameters()},
                                           ], lr=0.0001)
        ...
        optimizer_base = torch.optim.Adam([{"params": SFT_NAML_model.news_encoder.parameters()},
                                           {"params": SFT_NAML_model.user_encoder.parameters()},
                                           {"params": SFT_NAML_model.news_att_encoder.parameters()},
                                           {"params": SFT_NAML_model.user_att_encoder.parameters()},
        ...
        for para in SFT_NAML_model.named_parameters():
            print(para[0])
        self.trainer = Trainer(args, SFT_NAML_model, optimizer_att, optimizer_base, optimizer_Zeroshot_news, optimizer_Zeroshot_user, data)
