...
class Trainer():
    ...
    def _save_checkpoint(self, epoch):
        ...
        filename_SFT_NPA_ATT = self.args.checkpoint_dir + ('checkpoint-SFT_NPA-epoch{}.pth'.format(epoch))
        torch.save(state_model, filename_SFT_NPA_ATT)
    ...
    def test(self):
        ...
        # 存储预测结果
        folder_path = '../predict/SFT_NPA_ATT/'
        ...
        predict_df.to_csv(f'{folder_path}/SFT_NPA_predict.csv', index = False)
