...
def get_word_embedding(model):
    ...
    np.save('../Data/metadata/news_title_word_embedding.npy', word_embedding)
...
def get_category_embedding(model):
    ...
    np.save('../Data/metadata/news_category_embedding.npy', category_embedding)
...
def get_subcategory_embedding(model):
    ...
    np.save('../Data/metadata/news_subcategory_embedding.npy', subcategory_embedding)
