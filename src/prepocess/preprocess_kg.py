...
def get_transE_embedding(entity_index_list, relation_index_list, graph_index, news_entity_num, news_entity_embedding):
    ...
    transE = TransE(entity_index_list, relation_index_list, graph_index, epochs=30, batch_size=1024, embedding_dim=100, lr=0.01, margin=1.0, norm=2)
